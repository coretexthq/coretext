...
ALWAYS populate it using the exact template located at `.agents/skills/coretext/rules_template.md`. Use the `view_file` tool to read the template if you are unfamiliar with it.
